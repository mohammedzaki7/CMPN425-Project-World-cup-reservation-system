...
//                     <label htmlFor = "firstName">firstName</label>
//                     <input value = {this.state.firstName} onChange = {
//                         (e) => this.setState({firstName: e.target.value})} type = "text" id = "firstName" name = "firstName" />

//                     <label htmlFor = "lastName">lastName</label>
//                     <input value = {this.state.lastName} onChange = {
//                         (e) => this.setState({lastName: e.target.value})} type = "text" id = "lastName" name = "lastName" />

//                     <label htmlFor = "birthDate">birthDate</label>
//                     <input value = {this.state.birthDate} onChange = {
//                         (e) => this.setState({birthDate: e.target.value})} type = "date" id = "birthDate" name = "birthDate" />

//                     <label htmlFor = "gender">gender</label>
//                     <input value = {this.state.gender} onChange = {
//                         (e) => this.setState({gender: "male"})} type = "radio" id = "gender" name = "gender" />Male 
//                     <input value = {this.state.gender} onChange = {
//                         (e) => this.setState({gender: "female"})} type = "radio" id = "gender" name = "gender" />Female

//                     <label htmlFor = "nationality">nationality</label>
//                     <select value = {this.state.nationality} onChange = {
//                         (e) => this.setState({nationality: e.target.value})} id = "nationality" name="nationality">
//                         <option value="">-- select one --</option>
//                         <option value="afghan">Afghan</option>
//                         <option value="albanian">Albanian</option>
//                         <option value="algerian">Algerian</option>
...
//                         (e) => this.setState({username: e.target.value})} id = "email" name = "email"/>

//                     <label htmlFor = "role">role</label>
//                     <select value = {this.state.role} onChange = {
//                         (e) => this.setState({role: e.target.value})} id = "role" name="role">
//                         <option value="">-- select role --</option>
//                         <option value="manager">Manager</option>
//                         <option value="fan">Fan</option>
//                     </select>
